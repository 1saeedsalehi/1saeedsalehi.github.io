...
همانطور که مشاهده میکنید ما در action controller از خالی نبودن نام اطمینان حاصل کردیم و سپس آن را به متد UpdateName ارجاع دادیم . ولی اگه به بدنه متد UpdateName دقت کنید ، میبینید که مجددا از خالی نبودن نام اطمینان حاصل کرده ایم و 
* در صورت خالی بودن یک Exception پرت میکنیم! *
به این مدل چک کردن ها توی دامین های مختلف معمولا میگیم guard clause و میشه بگیم یه جور قرارداد بین برنامه نویس هاست. 

اگه طبق تعریفی که بالاتر اراه کردیم هم چک کنیم میتونیم حدس بزنیم که 
* خالی بودن نام نشان یک باگ در نرم افزار است!*
